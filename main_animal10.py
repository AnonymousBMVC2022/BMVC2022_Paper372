...
parser.add_argument('--dataset_path', default='/import/nobackup_mmv_ioannisp/fc312/datasets/ANIMAL-10N', help='dataset path')
...
def main():
    ...
    global logger
    logger = wandb.init(project='animal10n', entity='mrchenfeng', name=args.run_path)
